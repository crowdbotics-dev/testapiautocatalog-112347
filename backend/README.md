...
## Project Structure
    ...
    ├── testapiautocatalog_112347  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_112347`
...
2. Clone this repo and `cd testapiautocatalog_112347`
